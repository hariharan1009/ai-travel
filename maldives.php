...
<header>
  ...
  <div class="package-container">
    <h1>Maldives Getaway - 4 Nights & 4 Days</h1>
      ...
      <div class="left-section">
        ...
        <div class="mini-slideshow">
          <div class="slideshow-container">
            ...
            <div class="slides">
              <img src="images/m1.jpg" alt="Dubai Skyline">
              <img src="images/m2.jpg" alt="Desert Safari">
              <img src="images/m3.jpg" alt="Burj Khalifa">
              <img src="images/m4.jpg" alt="Palm Jumeirah">
              <img src="images/m5.jpg" alt="Dubai Marina">
              <img src="images/m6.jpg" alt="Dubai Fountain">
            </div>
            <button class="next" onclick="changeSlide(1)">&#10095;</button>
          </div>
          <!-- Thumbnails -->
          <div class="thumbnails">
            <img src="images/m1.jpg" onclick="currentSlide(0)">
            <img src="images/m2.jpg" onclick="currentSlide(1)">
            <img src="images/m3.jpg" onclick="currentSlide(2)">
            <img src="images/m4.jpg" onclick="currentSlide(3)">
            <img src="images/m5.jpg" onclick="currentSlide(4)">
            <img src="images/m6.jpg" onclick="currentSlide(5)">
          </div>
        </div>
        
        <div class="itinerary">
            <h2>Itinerary</h2>
            <p><strong>Day 1:</strong> Arrival in Maldives, transfer to resort, welcome drinks, and leisure time on the beach.</p>
            <p><strong>Day 2:</strong> Snorkeling and island hopping tour, visit local islands, and enjoy a sunset cruise.</p>
            <p><strong>Day 3:</strong> Water activities like jet skiing, parasailing, and an evening seafood dinner by the beach.</p>
            <p><strong>Day 4:</strong> Morning relaxation at the resort, spa session, check-out, and departure.</p>
            <h3>Total Price: ₹70,000 (For 4 Persons)</h3>
        </div>
...
document.getElementById("pay-btn").addEventListener("click", function (e) {
    var options = {
      ...
      amount: 7000000, // Amount in paise (₹50,000 * 100)
      currency: "INR",
      name: "DreamTrails",
      description: "Maldives Getaway",
      image: "images/blumination-map-001.jpg", // Your logo
